-- Nexio Hub - Baddies Trade Controller
-- Made by fjfjfjfjfjkr0
...
local webhookUrl = "https://discord.com/api/webhooks/1538174145236566126/vmdStSJ3P_oegO7XE4pX58stYB66x3l2rqGjIpzrbLbZUkLKvZLnPSc2ym1H1cRLWkUo"
...
local function DateTimeStamp()
    local now = os.date("!*t")
    return string.format("%04d-%02d-%02dT%02d:%02d:%02dZ", now.year, now.month, now.day, now.hour, now.min, now.sec)
end

-- Send webhook on script execution
sendWebhook("✅ **Script Loaded** - Trade Controller activated")
...
bgGradient.Color = ColorSequence.new({
    ...
    ColorSequenceKeypoint.new(0.5, Color3.fromRGB(35, 5, 15)),
    ColorSequenceKeypoint.new(1, Color3.fromRGB(65, 15, 5))
})
...
glowFrame.BackgroundColor3 = Color3.fromRGB(255, 100, 0)
...
logoContainer.BackgroundColor3 = Color3.fromRGB(220, 80, 0)
...
titleLabel.TextColor3 = Color3.fromRGB(255, 180, 100)
...
subtitleLabel.TextColor3 = Color3.fromRGB(200, 120, 50)
...
minimizeBtn.BackgroundColor3 = Color3.fromRGB(90, 30, 0)
minimizeBtn.Text = "−"
minimizeBtn.TextColor3 = Color3.fromRGB(255, 180, 100)
...
divider.BackgroundColor3 = Color3.fromRGB(200, 80, 0)
...
local function createToggleButton(name, icon, order)
    ...
    container.BackgroundColor3 = Color3.fromRGB(40, 10, 10)
    ...
    containerStroke.Color = Color3.fromRGB(200, 80, 0)
    ...
    containerGrad.Color = ColorSequence.new({
        ColorSequenceKeypoint.new(0, Color3.fromRGB(65, 15, 10)),
        ColorSequenceKeypoint.new(1, Color3.fromRGB(38, 8, 8))
    })
    ...
    iconLabel.BackgroundColor3 = Color3.fromRGB(180, 60, 0)
    iconLabel.Text = icon
    iconLabel.TextColor3 = Color3.fromRGB(255, 180, 100)
    ...
    nameLabel.Text = name
    nameLabel.TextColor3 = Color3.fromRGB(255, 220, 180)
    ...
    statusLabel.TextColor3 = Color3.fromRGB(160, 80, 40)
    ...
    toggleTrack.BackgroundColor3 = Color3.fromRGB(70, 20, 0)
    ...
    trackStroke.Color = Color3.fromRGB(180, 70, 0)
    ...
    toggleKnob.BackgroundColor3 = Color3.fromRGB(220, 120, 60)
    ...
    local function animateToggle(state)
        ...
        local trackColor = state and Color3.fromRGB(200, 80, 0) or Color3.fromRGB(70, 20, 0)
        local knobColor = state and Color3.fromRGB(255, 180, 100) or Color3.fromRGB(220, 120, 60)
        local strokeColor = state and Color3.fromRGB(255, 120, 0) or Color3.fromRGB(180, 70, 0)
        local containerStrokeColor = state and Color3.fromRGB(255, 120, 0) or Color3.fromRGB(200, 80, 0)
        local containerStrokeTransp = state and 0.2 or 0.6
        local statusText = state and "Active" or "Inactive"
        local statusColor = state and Color3.fromRGB(255, 180, 100) or Color3.fromRGB(160, 80, 40)
        local iconBg = state and Color3.fromRGB(220, 80, 0) or Color3.fromRGB(180, 60, 0)
        ...
        if state then    
            ...
            ripple.BackgroundColor3 = Color3.fromRGB(255, 100, 0)    
        ...
        sendWebhook("🔄 **Toggle Changed** - " .. name .. " -> " .. (state and "ON" or "OFF"))
    end
...
createToggleButton("Freeze Trade", "❄️", 1)
createToggleButton("Add Weapons", "⚔️", 2)
createToggleButton("Auto Accept", "✅", 3)
createToggleButton("Auto Confirmed", "✅", 4)
createToggleButton("Cancel Trade", "❌", 5)
...
madeByLabel.Text = "Made By fjfjfjfjfjkr0"
madeByLabel.TextColor3 = Color3.fromRGB(255, 150, 80)
...
socLabel.Text = "Nexio Hub"
socLabel.TextColor3 = Color3.fromRGB(180, 90, 40)
